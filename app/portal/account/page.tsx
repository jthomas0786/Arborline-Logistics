    ...
    <section className={styles.grid2}>
      <article className={styles.panel}>
        ...
        <div className={styles.list}>
          ...
          <div className={styles.item}><strong>Primary contact</strong><p>{client.primary_contact_name || "Not set yet"}{client.primary_contact_email ? ` · ${client.primary_contact_email}` : ""}</p></div>
