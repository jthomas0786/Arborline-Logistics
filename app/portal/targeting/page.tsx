...
export default async function TargetingPage() {
  ...
  return <PortalShell active="Targeting">
    ...
    <div className={styles.notice} style={{marginTop:16}}>Want to change your targeting? Reply to your ArborLine email. Client-side targeting change requests will be added after the pilot workflow is validated.</div>
  </PortalShell>;
}
