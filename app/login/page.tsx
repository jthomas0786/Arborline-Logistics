  ...
  return <main className={styles.shell}><section className={styles.frame}>
    <aside className={styles.visual} aria-label="ArborLine Logistics automated freight brokerage">
      <div className={styles.visualHero}>
        <img src="/brand/arborline-banner.jpg" alt="ArborLine Logistics — Automated Freight Brokerage" width={1800} height={600}/>
      </div>
    ...
    <section className={styles.card}>
      <div className={styles.brand}>
        <img src="/brand/arborline-badge.png" alt="ArborLine Logistics" width={256} height={256}/>
        <div><strong>Arbor<span>Line</span></strong><small>LOGISTICS · SECURE ACCESS</small></div>
      </div>
