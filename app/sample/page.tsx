  ...
  return <main className={styles.page}>
    ...
    <section className={styles.pilot} style={{paddingTop:72}}>
      <div className={styles.pilotCopy}>
        ...
        <p>Tell us what your business does and who your ideal customer is. ArborLine will use your target profile to prepare a small, localized sample of matching businesses so you can judge the fit before becoming a client.</p>
        ...
        <ul>
          ...
          <li>Focused on a city, metro, or local region you actually serve</li>
      ...
      <form className={styles.form} method="post" action="/api/public/free-sample">
        ...
        <div className={styles.formRow}><label>Target geography<input name="serviceArea" placeholder="e.g. Chicago metro, Naperville IL, Northwest Indiana" maxLength={180} required/></label><label>Website<input name="website" type="url" placeholder="https://" maxLength={300}/></label></div>
        ...
        <small>For the first sample, choose a city, metro, or local region rather than “nationwide.” This request does not create a paid account, enroll you in outreach, or authorize ArborLine to contact prospects on your behalf.</small>
      </form>
    </section>
