    ...
    try {
      ...
      const inserted = await db.query(
        ...
        [
          ...
          prospect.client_id,
          CONNECT_FROM_EMAIL,
          prospect.outreach_recipient_email,
          subject,
          body,
          experimentKey,
          experimentVariant,
